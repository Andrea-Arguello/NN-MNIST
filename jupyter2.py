...
#   np.random.rand(*theta_shape)/NETWORK_ARCH[1]**0.5 for theta_shape in theta_shapes 
#])
#np.save('flat_thetas_model_2',flat_thetas)
flat_thetas = np.load('flat_thetas_model_2.npy')
...
print(result)
#np.save('result_model_2',result.x) #we don't want to run this again o se overwritea
